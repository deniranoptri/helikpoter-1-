...
(async () => {
  ...
  await page.setContent(`
    <html>
      ...
      <body>
        <div class="container">
             <div class="absolute pointer-events-none z-0" style="position: absolute; width: 90%; height: 6.25%; top: 11.5%; left: 49%; transform: translateX(-50%); outline: 1px solid lime;">

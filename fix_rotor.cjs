...
(async () => {
  ...
  await page.setContent(`
    <html>
      ...
      <body>
        <div class="container">
             <div class="absolute pointer-events-none z-0" style="position: absolute; width: 90%; height: 6.25%; top: 8.5%; left: 44.8%; transform: translateX(-50%); outline: 1px solid lime;">
  ...
  // also get exact rendered coordinates
  const rects = await page.evaluate(() => {
    ...
    return {
       anchor: { top: ar.top - br.top, center: ar.top + ar.height/2 - br.top, height: ar.height },
       body: { height: br.height }
    };
  });
  console.log(rects);
